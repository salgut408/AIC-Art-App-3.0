...
class Constants {
    ...
    const val BASE_URL = " https://api.artic.edu/api/v1/"
        const val FIELD_TERMS ="fields=title,iiif_url,classification_title,id,image_id,artist_title,medium_display,provenance_text,latitude,longitude,is_public_domain,inscriptions,artist_display,iiif_url,artist_title,place_of_origin,credit_line,colorfulness"
        const val SEARCH_ART_TIME_DELAY = 500L
